...
// import neuImage from "../public/images/NEU.jpg";
  ...
  return (
      ...
      <div id="wd-kanbas-navigation" className="list-group rounded-0 position-fixed bottom-0 top-0 d-none d-md-block bg-black z-2"
        ...
        <a id="wd-course-link" href="#/Kanbas/Courses"
          ...
          <a id="wd-dashboard-link" href="#/Kanbas/Calender"
          className="list-group-item text-white
                    bg-black text-center border-0">
          <FaCalendarAlt className="fs-1 text-danger" /><br />
          Calender</a>

          <a id="wd-dashboard-link" href="#/Kanbas/Inbox"
          className="list-group-item text-white
                    bg-black text-center border-0">
          <FaInbox className="fs-1 text-danger" /><br />
          Inbox</a>

          <a id="wd-dashboard-link" href="#/Kanbas/Labs"
          className="list-group-item text-white
                    bg-black text-center border-0">
