...
//   const fetchStudentCourses = async () => {
//     const courseNumbers = enrolledCourses;
//     const fetchedEnrolledCourses = await clientCourse.fetchCoursesByNumber(courseNumbers);
...
//       // Update the state with a callback to ensure it's using the latest state
//       setEnrolledCourses((prevCourses) => {
//         const newCourses = [...prevCourses, selectedCourse];
//         return newCourses;
//       });
  
//       // Update the server and then fetch the updated list of student courses
//       await client.StudentEnrollCourse(currentUser._id, updatedEnrolledCourses);
  
//       // Fetch the updated courses after the enrollment
//       fetchStudentCourses();
//     } else if (enrolledCourses.includes(selectedCourse)) {
//       alert("You are already enrolled in this course.");
//     } else {
